...
def go_home():
    subprocess.Popen([sys.executable, "SkeletonV3/Gui.py"])
    root.destroy()


img = Image.open("SkeletonV3/Images/Logo.png")
...
def job_selected(event):
    ...
    if selected_job == "Engineer":
        subprocess.Popen(["python", "SkeletonV3/Jobs/EngineeringWindow/Engineering.py"])
        root.destroy()

    elif selected_job == "Physicist":
        subprocess.Popen(["python", "SkeletonV3/Jobs/Physicist.py"])
        root.destroy()
