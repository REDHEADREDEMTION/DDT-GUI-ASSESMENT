...
def go_home():
    subprocess.Popen([sys.executable, "RealProgect/SkeletonV2/Gui.py"])
    root.destroy()


img = Image.open("RealProgect/SkeletonV2/Images/Logo.png")
...
def job_selected(event):
    ...
    if selected_job == "Engineer":
        subprocess.Popen(["python", "RealProgect/SkeletonV2/Jobs/EngineeringWindow/Engineering.py"])
        root.destroy()

    elif selected_job == "Physicist":
        subprocess.Popen(["python", "RealProgect/SkeletonV2/Jobs/Physicist.py"])
        root.destroy()
