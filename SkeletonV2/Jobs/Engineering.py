...
def go_home():
    subprocess.Popen([sys.executable, "SkeletonV2/Gui.py"])
    root.destroy()


img = Image.open("SkeletonV2/Images/Logo.png")
...
def job_selected(event):
    ...
    if selected_job == "Engineer":
        subprocess.Popen(["python", "SkeletonV2/Jobs/EngineeringWindow/Engineering.py"])
        root.destroy()
